...
/* Fetch client SSL context */
tsapi TSReturnCode TSSslClientContextsGet(int n, const char **result, int *actual);
tsapi TSSslContext TSSslClientContextFind(const string name);
